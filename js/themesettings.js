...
function addHtmlTab(){
    ...
    html += '<h3 id="title">Smart Gateway theme V.' + theme.version + '</h3><br/>';
    html += '<p>This is a theme for Smart Gateway.<br/>';
    html += '<h3>General features</h3>';
    html += '<p>The theme has several features that change the look. It saves the settings in localStorge in your browser. You can have diffrent settings in seperate devices. Some of the cool features are:</p>';
    html += '<b>Theme settings menu:</b>';
